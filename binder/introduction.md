...
The limit was, as far back as we can recall, the `limen` in Latin-speaking households: the threshold, the doorway between the domestic _(domus)_ and the savage _(silva)_. From there, it became a boundary or limit between fields; the hedgerows of FitzGerald's Britain come easily to mind, strips of herbage between the sown.
